...
namespace ApiSdk
{
    ...
    public partial class ApiClient : BaseRequestBuilder
    {
        ...
        public global::ApiSdk.App.AppRequestBuilder App
        {
            get => new global::ApiSdk.App.AppRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The templates property</summary>
        public global::ApiSdk.Templates.TemplatesRequestBuilder Templates
        {
            get => new global::ApiSdk.Templates.TemplatesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        ...
        public ApiClient(IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}", new Dictionary<string, object>())
        {
            ...
            {
                RequestAdapter.BaseUrl = "https://reqres.in";
            }
